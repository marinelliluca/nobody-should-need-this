...
Once the test completes, the model is ready. You can close the `tnr connect` terminal, but **keep the SSH session open**, since it holds the port-forwarding tunnel.
